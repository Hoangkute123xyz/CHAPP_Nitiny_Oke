...
import vn.chapp.nitiny.BuildConfig;
...
import vn.chapp.nitiny.models.map.DetailPlaceResponse;
import vn.chapp.nitiny.models.map.PlaceResponse;
...
import static vn.chapp.nitiny.data.network.NetworkEndPoint.GET_AUTOCOMPLETE_PLACE;
import static vn.chapp.nitiny.data.network.NetworkEndPoint.GET_DETAIL_PLACE;
import static vn.chapp.nitiny.data.network.NetworkEndPoint.GET_DETAIL_PLACE_COMPONENT;
import static vn.chapp.nitiny.data.network.NetworkEndPoint.GET_GUIDE;
import static vn.chapp.nitiny.data.network.NetworkEndPoint.GET_LIST_SERVICE;
import static vn.chapp.nitiny.data.network.NetworkEndPoint.GET_LIST_SHOP_LINKED;
...
public interface AppApi {
    ...
    @FormUrlEncoded
    @POST(NetworkEndPoint.EDIT_PRODUCT_TO_CART)
    Observable<Response<Object>> PlusProtoCart(@Field("user_id") String user_id, @Field("product_id") String product_id, @Field("number") String number);

    //them
    @FormUrlEncoded
    @POST(NetworkEndPoint.EDIT_PRODUCT_TO_CART)
    Observable<Response<Object>> MinusProtoCart(@Field("user_id") String user_id, @Field("product_id") String product_id, @Field("number") String number);

    @GET(NetworkEndPoint.GET_BANNER)
    Observable<Response<List<String>>> getBanner();

    @GET(NetworkEndPoint.GET_NOTIFICATION)
    Observable<Response<List<Notify>>> getNoti(@Query("user_id") String userId);
}
