...
//    }
    ...
    public void onClickScheduled(View v) {
        ...
        if (payment == 1) {
            //chạy ok, code rất tốt nhưng app rất tiếc, chưa hoạt động ví :D
...
//            }
            ...
            //app chưa dùng ví
            Toast.makeText(getContext(), "Chức năng này tạm thời chưa hoạt động. Vui lòng chọn phương thức thanh toán khác!", Toast.LENGTH_SHORT).show();
            return;
        }
...
//        txtTotalPrice.setText(totalPrice+"");
        txtTotalPrice.setText(String.format("%s điểm", CommonUtils.parseMoney(totalPrice)));
    }
