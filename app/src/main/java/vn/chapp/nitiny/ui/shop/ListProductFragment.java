...
import vn.chapp.nitiny.base.NothingSelectedSpinnerAdapter;
...
import vn.chapp.nitiny.models.service.CategoryFilter;
...
//        rcProduct.addItemDecoration(new ListProductItemDecoration()); //fix chỗ khác rồi :D
