...
import vn.chapp.nitiny.base.AsyncTaskExecutor;
...
import vn.chapp.nitiny.ui.widget.UiToolbar;
...
public class BackableActivity extends BaseActivity implements BackableMvpView, UiToolbar.OnToolbarWithBackClickListener {
    ...
    public static final String NAVIGATOR_FNT = "NAVIGATOR_FNT";
    public static final String NAVIGATOR_FNTDT = "NAVIGATOR_FNTDT";
    ...
    public static Intent newInstanceNotificationDetail(Context context, String navigator, Notify notify) {
        Intent intent = new Intent(context, BackableActivity.class);
        intent.putExtra(ARG_NAVIGATOR, navigator);
        intent.putExtra(NotificationDetailFragment.ARG_NOTIFICATION_DETAIL, notify);
        return intent;
    }
    ...
    protected void init() {
        ...
        notify = getIntent().getExtras().getParcelable(NotificationDetailFragment.ARG_NOTIFICATION_DETAIL);
...
//                        toolbar.setActionRight(true, R.drawable.ic_credit_card);
                    ...
                    case NAVIGATOR_FNT:
                        ...
                        break;
                    case NAVIGATOR_FNTDT:
                        title = getString(R.string.title_detail_notification);
                        fragment = NotificationDetailFragment.newInstance(notify);
                        TAG = NotificationDetailFragment.TAG;
                        break;
                }
                if (fragment != null) {
