...
public class DetailPromotionFrPresenter<V extends DetailPromotionFrMvpView> extends BasePresenter<V> implements DetailPromotionFrMvpPresent<V> {

    @Inject
    public DetailPromotionFrPresenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
