...
public class BookingAdapter extends BaseAdapter<Booking> {
    ...
    //cái booking này củ chuối bị ngược nha :D
    ...
    class BookingViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            //them
            if (!TextUtils.isEmpty(String.valueOf(booking.getType()))) {
                tvBookingType.setText(booking.getType() == TYPE_SERVICE ? "Đơn quà" : "Đơn Hàng");
            } else tvBookingType.setText("Chưa rõ");
...
//            tvStatus.setVisibility(String.valueOf(booking.getActive()).equals("1") ? View.GONE : View.VISIBLE);
            ...
            itemView.setOnClickListener(new View.OnClickListener() { //xem chi tiet
                ...
                public void onClick(View v) {
                    if (onActiveActionClickListener != null)
                        onActiveActionClickListener.onClickViewDetail(getCurrentPosition(), getCollection().get(getCurrentPosition()).getId());
                }
            });
        }
